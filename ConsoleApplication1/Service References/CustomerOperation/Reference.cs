...
namespace ConsoleApplication1.CustomerOperation {
    ...
    [System.SerializableAttribute()]
    public partial class ExpandedPurchaseTicket : ConsoleApplication1.CustomerOperation.PurchaseTicket {
    ...
    [System.SerializableAttribute()]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(ConsoleApplication1.CustomerOperation.ExpandedPurchaseTicket))]
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CustomerOperation.ICustomerOperationService")]
    public interface ICustomerOperationService {
        ...
        ConsoleApplication1.CustomerOperation.BoostAccount[] GetAllBoostAccount(string userName, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerOperationService/GetAllBoostAccount", ReplyAction="http://tempuri.org/ICustomerOperationService/GetAllBoostAccountResponse")]
        System.Threading.Tasks.Task<ConsoleApplication1.CustomerOperation.BoostAccount[]> GetAllBoostAccountAsync(string userName, string password);
        ...
        ConsoleApplication1.CustomerOperation.ExpandedPurchaseTicket[] GetAllPurchaseTicket(string userName, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerOperationService/GetAllPurchaseTicket", ReplyAction="http://tempuri.org/ICustomerOperationService/GetAllPurchaseTicketResponse")]
        System.Threading.Tasks.Task<ConsoleApplication1.CustomerOperation.ExpandedPurchaseTicket[]> GetAllPurchaseTicketAsync(string userName, string password);
        ...
        ConsoleApplication1.CustomerOperation.PurchaseTicket[] GetActivePurchaseTicket(string userName, string password, string deviceId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerOperationService/GetActivePurchaseTicket", ReplyAction="http://tempuri.org/ICustomerOperationService/GetActivePurchaseTicketResponse")]
        System.Threading.Tasks.Task<ConsoleApplication1.CustomerOperation.PurchaseTicket[]> GetActivePurchaseTicketAsync(string userName, string password, string deviceId);
        ...
        void CreateNewPurchaseTicket(string userName, string password, ConsoleApplication1.CustomerOperation.PurchaseTicket purchaseTicket, int howManyTickets);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerOperationService/CreateNewPurchaseTicket", ReplyAction="http://tempuri.org/ICustomerOperationService/CreateNewPurchaseTicketResponse")]
        System.Threading.Tasks.Task CreateNewPurchaseTicketAsync(string userName, string password, ConsoleApplication1.CustomerOperation.PurchaseTicket purchaseTicket, int howManyTickets);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICustomerOperationServiceChannel : ConsoleApplication1.CustomerOperation.ICustomerOperationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CustomerOperationServiceClient : System.ServiceModel.ClientBase<ConsoleApplication1.CustomerOperation.ICustomerOperationService>, ConsoleApplication1.CustomerOperation.ICustomerOperationService {
        ...
        public ConsoleApplication1.CustomerOperation.BoostAccount[] GetAllBoostAccount(string userName, string password) {
            return base.Channel.GetAllBoostAccount(userName, password);
        }
        
        public System.Threading.Tasks.Task<ConsoleApplication1.CustomerOperation.BoostAccount[]> GetAllBoostAccountAsync(string userName, string password) {
            return base.Channel.GetAllBoostAccountAsync(userName, password);
        }
        
        public ConsoleApplication1.CustomerOperation.ExpandedPurchaseTicket[] GetAllPurchaseTicket(string userName, string password) {
            return base.Channel.GetAllPurchaseTicket(userName, password);
        }
        
        public System.Threading.Tasks.Task<ConsoleApplication1.CustomerOperation.ExpandedPurchaseTicket[]> GetAllPurchaseTicketAsync(string userName, string password) {
            return base.Channel.GetAllPurchaseTicketAsync(userName, password);
        }
        
        public ConsoleApplication1.CustomerOperation.PurchaseTicket[] GetActivePurchaseTicket(string userName, string password, string deviceId) {
            return base.Channel.GetActivePurchaseTicket(userName, password, deviceId);
        }
        
        public System.Threading.Tasks.Task<ConsoleApplication1.CustomerOperation.PurchaseTicket[]> GetActivePurchaseTicketAsync(string userName, string password, string deviceId) {
        ...
        public void CreateNewPurchaseTicket(string userName, string password, ConsoleApplication1.CustomerOperation.PurchaseTicket purchaseTicket, int howManyTickets) {
            base.Channel.CreateNewPurchaseTicket(userName, password, purchaseTicket, howManyTickets);
        }
        
        public System.Threading.Tasks.Task CreateNewPurchaseTicketAsync(string userName, string password, ConsoleApplication1.CustomerOperation.PurchaseTicket purchaseTicket, int howManyTickets) {
