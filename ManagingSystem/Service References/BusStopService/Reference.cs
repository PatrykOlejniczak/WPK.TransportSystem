...
namespace ManagingSystem.BusStopService {
    ...
    public interface IBusStopSecureService {
        ...
        void Create(ManagingSystem.BusStopService.BusStop busStop);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBusStopSecureService/Create", ReplyAction="http://tempuri.org/IBusStopSecureService/CreateResponse")]
        System.Threading.Tasks.Task CreateAsync(ManagingSystem.BusStopService.BusStop busStop);
        ...
        void Update(ManagingSystem.BusStopService.BusStop busStop);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBusStopSecureService/Update", ReplyAction="http://tempuri.org/IBusStopSecureService/UpdateResponse")]
        System.Threading.Tasks.Task UpdateAsync(ManagingSystem.BusStopService.BusStop busStop);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBusStopSecureServiceChannel : ManagingSystem.BusStopService.IBusStopSecureService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BusStopSecureServiceClient : System.ServiceModel.ClientBase<ManagingSystem.BusStopService.IBusStopSecureService>, ManagingSystem.BusStopService.IBusStopSecureService {
        ...
        public void Create(ManagingSystem.BusStopService.BusStop busStop) {
            base.Channel.Create(busStop);
        }
        
        public System.Threading.Tasks.Task CreateAsync(ManagingSystem.BusStopService.BusStop busStop) {
            return base.Channel.CreateAsync(busStop);
        }
        
        public void Update(ManagingSystem.BusStopService.BusStop busStop) {
            base.Channel.Update(busStop);
        }
        
        public System.Threading.Tasks.Task UpdateAsync(ManagingSystem.BusStopService.BusStop busStop) {
    ...
    public interface IBusStopService {
        ...
        ManagingSystem.BusStopService.BusStop[] GetAll();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBusStopService/GetAll", ReplyAction="http://tempuri.org/IBusStopService/GetAllResponse")]
        System.Threading.Tasks.Task<ManagingSystem.BusStopService.BusStop[]> GetAllAsync();
        ...
        ManagingSystem.BusStopService.BusStop GetById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBusStopService/GetById", ReplyAction="http://tempuri.org/IBusStopService/GetByIdResponse")]
        System.Threading.Tasks.Task<ManagingSystem.BusStopService.BusStop> GetByIdAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBusStopServiceChannel : ManagingSystem.BusStopService.IBusStopService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BusStopServiceClient : System.ServiceModel.ClientBase<ManagingSystem.BusStopService.IBusStopService>, ManagingSystem.BusStopService.IBusStopService {
        ...
        public ManagingSystem.BusStopService.BusStop[] GetAll() {
            return base.Channel.GetAll();
        }
        
        public System.Threading.Tasks.Task<ManagingSystem.BusStopService.BusStop[]> GetAllAsync() {
            return base.Channel.GetAllAsync();
        }
        
        public ManagingSystem.BusStopService.BusStop GetById(int id) {
            return base.Channel.GetById(id);
        }
        
        public System.Threading.Tasks.Task<ManagingSystem.BusStopService.BusStop> GetByIdAsync(int id) {
